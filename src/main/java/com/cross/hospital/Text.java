...
public class Text {
    ...
    public static void title(String str){
        System.out.println(BLUE_BOLD + WHITE_BACKGROUND_BRIGHT +  " ====== " + str + " ====== " + RESET);
    }

    public static void paragraph(String str){
        System.out.println(CYAN + str + RESET);
    }

    public static void section(String str){
        System.out.println(GREEN_BOLD + " ------ " + str + " ------ " + RESET);
    }

    public static void subSection(String str){
        System.out.println(YELLOW_BOLD + str + RESET);
    }

    public static void warning(String str){
        System.out.println(RED_BACKGROUND + WHITE_BOLD_BRIGHT + "  " + str + "  " + RESET);
    }
